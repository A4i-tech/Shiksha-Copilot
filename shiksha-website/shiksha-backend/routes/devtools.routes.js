...
router.post("/auth/reset", isAuthenticated, requirePermission("devtools.auth"), asyncMiddleware(controller.resetAuth));
router.get("/sms/latest", isAuthenticated, requirePermission("devtools.auth"), asyncMiddleware(controller.latestSms));
