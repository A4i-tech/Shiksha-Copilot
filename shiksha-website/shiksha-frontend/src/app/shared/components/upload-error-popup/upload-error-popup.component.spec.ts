...
describe('UploadErrorPopupComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [DatePipe],
      imports: [MatSnackBarModule, NgIdleModule.forRoot(), TranslateModule.forRoot(), RouterTestingModule, ToastrModule.forRoot(), HttpClientTestingModule, UploadErrorPopupComponent]
    });
