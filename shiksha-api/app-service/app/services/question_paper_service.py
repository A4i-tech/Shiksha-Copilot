    ...
    async def _generate_questions_batch(
        ...
        try:
            ...
            user_message = (
                ...
                "IMPORTANT: For every question, you MUST include a correct `answer` field in the `item`. "
                "For MCQs, `answer` should be the label of the correct option (e.g. 'A'). "
                "For fill-in-the-blank questions, `answer` should be the word or phrase that fills the blank. "
                "For short and long answer questions, `answer` should be a concise model answer.\n\n"
